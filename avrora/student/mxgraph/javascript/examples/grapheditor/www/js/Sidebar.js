	...
	if (this.enableTooltips && this.showTooltips)
	{
		if (this.currentElt != elt)
		{
			...
			var show = mxUtils.bind(this, function()
			{
				...
				var containerOffset = DS.util.getOffsetRect(this.editorUi.container);
				var left = this.container.clientWidth + this.editorUi.splitSize + 3 + containerOffset.left + off.x;
				var top = Math.min(bottom - height - 20 /*status bar*/, Math.max(0, (containerOffset.top +
					containerOffset.top + elt.offsetTop - this.container.scrollTop - height / 2 + 16))) + off.y;
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
	 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;', 120, 60, '', 'Операция', null, null, 'rect rectangle box'),
 		...
 		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 120, 80, '', 'Начало/конец', null, null, 'oval ellipse state'),
		...
		// this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Circle', null, null, 'circle'),
	 	this.createVertexTemplateEntry('shape=process;whiteSpace=wrap;html=1;', 120, 60, '', 'Функция', null, null, 'process task'),
	 	this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=1;', 80, 80, '', 'Условие', null, null, 'diamond rhombus if condition decision conditional question test'),
	 	this.createVertexTemplateEntry('shape=switch;whiteSpace=wrap;html=1;', 80, 80, '', 'switch', null, null, 'diamond rhombus if condition decision conditional question test'),
	 	this.createVertexTemplateEntry('shape=parallelogram;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;', 120, 60, '', 'Ввод-вывод'),
	 	this.createVertexTemplateEntry('shape=hexagon;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;', 120, 80, '', 'Цикл for', null, null, 'hexagon preparation'),
	 	...
	 	// this.createVertexTemplateEntry('shape=trapezoid;perimeter=trapezoidPerimeter;whiteSpace=wrap;html=1;', 120, 60, '', 'Ввод/вывод'),
	    ...
	    this.createVertexTemplateEntry('shape=cycle_begin;whiteSpace=wrap;html=1;portConstraint=south;sourcePortConstraint=north;', 120, 60, '', 'Начало цикла'),
	    this.createVertexTemplateEntry('shape=cycle_end;whiteSpace=wrap;html=1;', 120, 60, '', 'Конец цикла'),
