...
getValue: function (a, b, c) {
	...
	try{
		...
		if (null != a && "function" == typeof a.constructor) {
			...
			e;
			for (e in a)
				e != mxObjectIdentity.FIELD_NAME && (null == b || 0 > mxUtils.indexOf(b, e)) && (d[e] = c || "object" != typeof a[e] ? a[e] : mxUtils.clone2(a[e]))
		}
		return d
	}
	catch(e){
		console.error(e);
		try{
			DS.invokeEvent('arm/error', DS.JSON.encode({a:a,b:b,c:c}));
		}
		catch(e){
			console.error(e);
		}
